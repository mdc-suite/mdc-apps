...
(* CORE_GENERATION_INFO="weight_s_17,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.345250,HLS_SYN_LAT=8128514,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=118,HLS_SYN_LUT=836}" *)
...
reg   [22:0] indvar_flatten1_reg_130;
reg   [19:0] indvar_flatten2_reg_141;
reg   [14:0] indvar_flatten3_reg_152;
reg   [1:0] hkern_reg_163;
reg   [13:0] indvar_flatten4_reg_174;
reg   [1:0] wkern_reg_185;
reg   [12:0] indvar_flatten_reg_196;
reg   [5:0] pkern_reg_207;
reg   [6:0] pout_reg_218;
wire   [0:0] exitcond_flatten4_fu_229_p2;
wire    ap_block_state2_pp0_stage0_iter0;
reg    ap_block_state3_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [22:0] indvar_flatten_next4_fu_235_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [1:0] tmp_mid2_fu_371_p3;
reg   [1:0] tmp_mid2_reg_651;
wire   [1:0] tmp_2_mid2_fu_427_p3;
reg   [1:0] tmp_2_mid2_reg_656;
wire   [5:0] tmp_4_mid2_fu_489_p3;
reg   [5:0] tmp_4_mid2_reg_661;
wire   [6:0] pout_1_fu_580_p2;
wire   [12:0] indvar_flatten_next_fu_592_p3;
wire   [13:0] indvar_flatten_next1_fu_606_p3;
wire   [14:0] indvar_flatten_next2_fu_620_p3;
wire   [19:0] indvar_flatten_next3_fu_634_p3;
wire    ap_CS_fsm_state1;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg   [1:0] ap_phi_mux_hkern_phi_fu_167_p4;
reg   [1:0] ap_phi_mux_wkern_phi_fu_189_p4;
reg   [5:0] ap_phi_mux_pkern_phi_fu_211_p4;
...
wire   [5:0] pkern_mid1_fu_419_p3;
wire   [0:0] exitcond_mid3_fu_451_p2;
wire   [0:0] tmp_4_fu_463_p2;
wire   [0:0] tmp_5_fu_469_p2;
wire   [0:0] tmp_6_fu_475_p2;
wire   [5:0] pkern_1_fu_457_p2;
wire   [6:0] pout_mid2_fu_481_p3;
wire   [11:0] tmp_7_fu_501_p3;
wire   [12:0] tmp_4_mid2_cast_fu_497_p1;
wire   [12:0] tmp_15_cast_fu_509_p1;
wire   [12:0] tmp_9_fu_513_p2;
wire   [14:0] tmp_10_fu_523_p3;
...
wire   [13:0] tmp_14_fu_551_p1;
wire   [15:0] p_shl_cast_fu_555_p3;
wire   [15:0] tmp_13_fu_547_p1;
wire   [15:0] tmp_2_mid2_cast_fu_435_p1;
wire   [15:0] tmp_15_fu_563_p2;
wire   [15:0] tmp_16_fu_569_p2;
wire   [12:0] indvar_flatten_op_fu_586_p2;
wire   [13:0] indvar_flatten13_op_fu_600_p2;
wire   [14:0] indvar_flatten37_op_fu_614_p2;
wire   [19:0] indvar_flatten71_op_fu_628_p2;
reg   [2:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
assign exitcond_flatten1_fu_265_p2 = ((indvar_flatten_reg_196 == 13'd2048) ? 1'b1 : 1'b0);

assign exitcond_flatten2_fu_277_p2 = ((indvar_flatten4_reg_174 == 14'd6144) ? 1'b1 : 1'b0);
...
assign exitcond_flatten3_fu_289_p2 = ((indvar_flatten3_reg_152 == 15'd18432) ? 1'b1 : 1'b0);

assign exitcond_flatten4_fu_229_p2 = ((indvar_flatten1_reg_130 == 23'd8128512) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_241_p2 = ((indvar_flatten2_reg_141 == 20'd387072) ? 1'b1 : 1'b0);
...
assign exitcond_fu_253_p2 = ((pout_reg_218 == 7'd64) ? 1'b1 : 1'b0);
...
assign indvar_flatten13_op_fu_600_p2 = (14'd1 + indvar_flatten4_reg_174);

assign indvar_flatten37_op_fu_614_p2 = (15'd1 + indvar_flatten3_reg_152);

assign indvar_flatten71_op_fu_628_p2 = (20'd1 + indvar_flatten2_reg_141);

assign indvar_flatten_next1_fu_606_p3 = ((tmp_fu_357_p2[0:0] === 1'b1) ? 14'd1 : indvar_flatten13_op_fu_600_p2);

assign indvar_flatten_next2_fu_620_p3 = ((tmp_3_fu_301_p2[0:0] === 1'b1) ? 15'd1 : indvar_flatten37_op_fu_614_p2);

assign indvar_flatten_next3_fu_634_p3 = ((exitcond_flatten_fu_241_p2[0:0] === 1'b1) ? 20'd1 : indvar_flatten71_op_fu_628_p2);

assign indvar_flatten_next4_fu_235_p2 = (indvar_flatten1_reg_130 + 23'd1);

assign indvar_flatten_next_fu_592_p3 = ((tmp_2_fu_413_p2[0:0] === 1'b1) ? 13'd1 : indvar_flatten_op_fu_586_p2);

assign indvar_flatten_op_fu_586_p2 = (13'd1 + indvar_flatten_reg_196);
...
assign pkern_1_fu_457_p2 = (6'd1 + pkern_mid1_fu_419_p3);

assign pkern_mid1_fu_419_p3 = ((tmp_2_fu_413_p2[0:0] === 1'b1) ? 6'd0 : ap_phi_mux_pkern_phi_fu_211_p4);

assign pout_1_fu_580_p2 = (7'd1 + pout_mid2_fu_481_p3);

assign pout_mid2_fu_481_p3 = ((tmp_6_fu_475_p2[0:0] === 1'b1) ? 7'd0 : pout_reg_218);
...
assign tmp_13_fu_547_p1 = tmp_12_fu_541_p2[15:0];

assign tmp_14_fu_551_p1 = tmp_12_fu_541_p2[13:0];
...
assign tmp_7_fu_501_p3 = {{pout_mid2_fu_481_p3}, {5'd0}};
