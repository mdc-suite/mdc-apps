...
(* CORE_GENERATION_INFO="line_buffer_13,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.341500,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=12,HLS_SYN_DSP=0,HLS_SYN_FF=329,HLS_SYN_LUT=1072}" *)
...
reg   [5:0] pkern_reg_437;
reg   [1:0] wkern_reg_448;
reg   [7:0] indvar_flatten1_reg_459;
reg   [1:0] hkern_reg_470;
reg   [8:0] indvar_flatten2_reg_481;
wire   [4:0] tmp_1_fu_492_p2;
wire    ap_CS_fsm_state2;
wire   [15:0] win_138_cast_fu_504_p1;
wire    ap_CS_fsm_state3;
wire   [6:0] hout_mid2_fu_514_p3;
reg   [6:0] hout_mid2_reg_911;
wire   [15:0] tmp_4_cast_fu_528_p1;
reg   [15:0] tmp_4_cast_reg_916;
wire   [11:0] indvar_flatten_next1_fu_532_p2;
reg   [11:0] indvar_flatten_next1_reg_922;
wire   [14:0] tmp_2_fu_538_p1;
wire    ap_CS_fsm_state4;
wire   [6:0] wout_mid_fu_542_p3;
reg   [6:0] wout_mid_reg_932;
wire   [0:0] or_cond_fu_577_p2;
reg   [0:0] or_cond_reg_938;
wire   [0:0] out_of_bounds_fu_619_p2;
wire   [4:0] pin_1_fu_625_p2;
reg   [4:0] pin_1_reg_946;
reg    ap_block_state5_pp0_stage0_iter0;
wire    ap_block_state6_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [63:0] tmp_24_cast_fu_671_p1;
reg   [63:0] tmp_24_cast_reg_956;
reg   [11:0] buffer_val_1_V_addr_reg_961;
reg   [11:0] buffer_val_2_V_addr_reg_967;
...
wire   [5:0] pkern_1_fu_825_p2;
reg   [5:0] pkern_1_reg_1021;
wire   [7:0] indvar_flatten_next_fu_837_p3;
reg   [7:0] indvar_flatten_next_reg_1026;
wire   [8:0] indvar_flatten_next2_fu_845_p2;
reg   [8:0] indvar_flatten_next2_reg_1031;
...
reg   [5:0] ap_phi_mux_pkern_phi_fu_441_p4;
reg   [1:0] ap_phi_mux_wkern_phi_fu_452_p4;
reg   [7:0] ap_phi_mux_indvar_flatten1_phi_fu_463_p4;
reg   [1:0] ap_phi_mux_hkern_phi_fu_474_p4;
reg   [8:0] ap_phi_mux_indvar_flatten2_phi_fu_485_p4;
wire   [63:0] tmp_29_cast_fu_818_p1;
wire   [15:0] out_val_V_fu_869_p5;
reg    ap_block_pp1_stage0_01001;
wire   [6:0] hout_1_fu_508_p2;
wire   [6:0] tmp_4_fu_522_p2;
wire   [6:0] tmp_7_fu_550_p2;
...
wire   [10:0] tmp_14_fu_631_p3;
wire   [5:0] tmp_16_fu_643_p3;
wire   [12:0] p_shl3_cast_fu_651_p1;
wire   [12:0] p_shl2_cast_fu_639_p1;
wire   [12:0] tmp_17_fu_655_p2;
wire   [12:0] tmp_18_fu_661_p1;
wire   [12:0] tmp_19_fu_665_p2;
...
wire   [5:0] pkern_mid2_fu_753_p3;
wire   [11:0] tmp_22_fu_769_p3;
wire   [6:0] tmp_23_fu_781_p3;
wire   [12:0] p_shl5_cast_fu_789_p1;
wire   [12:0] p_shl4_cast_fu_777_p1;
wire   [6:0] tmp_27_cast_fu_799_p1;
wire   [6:0] col_assign_fu_803_p2;
wire   [12:0] tmp_24_fu_793_p2;
wire   [12:0] tmp_22_cast_fu_808_p1;
wire   [12:0] tmp_25_fu_812_p2;
wire   [7:0] indvar_flatten_op_fu_831_p2;
reg   [8:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
reg    ap_idle_pp1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        tmp_24_cast_reg_956[12 : 0] <= tmp_24_cast_fu_671_p1[12 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        ...
        tmp_4_cast_reg_916[6 : 0] <= tmp_4_cast_fu_528_p1[6 : 0];
    end
end
...
assign exitcond2_fu_886_p2 = ((wout_1_fu_881_p2 == 7'd64) ? 1'b1 : 1'b0);

assign exitcond3_fu_677_p2 = ((ap_phi_mux_pin_phi_fu_347_p4 == 5'd31) ? 1'b1 : 1'b0);

assign exitcond_flatten1_fu_892_p2 = ((indvar_flatten_reg_310 == 12'd4095) ? 1'b1 : 1'b0);

assign exitcond_flatten2_fu_863_p2 = ((ap_phi_mux_indvar_flatten2_phi_fu_485_p4 == 9'd287) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_857_p2 = ((indvar_flatten_next_fu_837_p3 == 8'd96) ? 1'b1 : 1'b0);

assign exitcond_fu_851_p2 = ((pkern_1_fu_825_p2 == 6'd32) ? 1'b1 : 1'b0);
...
assign hout_1_fu_508_p2 = (hout_reg_299 + 7'd1);

assign hout_mid2_fu_514_p3 = ((exitcond1_reg_252[0:0] === 1'b1) ? hout_1_fu_508_p2 : hout_reg_299);

assign indvar_flatten_next1_fu_532_p2 = (indvar_flatten_reg_310 + 12'd1);

assign indvar_flatten_next2_fu_845_p2 = (ap_phi_mux_indvar_flatten2_phi_fu_485_p4 + 9'd1);

assign indvar_flatten_next_fu_837_p3 = ((ap_phi_mux_exitcond_flatten3_phi_fu_419_p4[0:0] === 1'b1) ? 8'd1 : indvar_flatten_op_fu_831_p2);

assign indvar_flatten_op_fu_831_p2 = (ap_phi_mux_indvar_flatten1_phi_fu_463_p4 + 8'd1);
...
assign pin_1_fu_625_p2 = (ap_phi_mux_pin_phi_fu_347_p4 + 5'd1);

assign pkern_1_fu_825_p2 = (pkern_mid2_fu_753_p3 + 6'd1);

assign pkern_mid2_fu_753_p3 = ((tmp_21_fu_747_p2[0:0] === 1'b1) ? 6'd0 : ap_phi_mux_pkern_phi_fu_441_p4);
...
assign tmp_10_fu_601_p2 = (($signed(win_2_reg_333) > $signed(16'd64)) ? 1'b1 : 1'b0);

assign tmp_12_fu_683_p2 = (($signed(win_2_reg_333) < $signed(16'd65)) ? 1'b1 : 1'b0);

assign tmp_14_fu_631_p3 = {{ap_phi_mux_pin_phi_fu_347_p4}, {6'd0}};
...
assign tmp_18_fu_661_p1 = win_2_reg_333[12:0];

assign tmp_19_fu_665_p2 = (tmp_17_fu_655_p2 + tmp_18_fu_661_p1);

assign tmp_1_fu_492_p2 = (tmp_reg_241 + 5'd1);
...
assign tmp_22_fu_769_p3 = {{pkern_mid2_fu_753_p3}, {6'd0}};
...
assign tmp_3_fu_498_p2 = ((tmp_reg_241 == 5'd31) ? 1'b1 : 1'b0);

assign tmp_4_cast_fu_528_p1 = tmp_4_fu_522_p2;

assign tmp_4_fu_522_p2 = (hout_mid2_fu_514_p3 + 7'd2);
...
assign tmp_7_fu_550_p2 = (7'd2 + wout_mid_fu_542_p3);

assign tmp_8_fu_595_p2 = (($signed(win_2_reg_333) < $signed(16'd1)) ? 1'b1 : 1'b0);

assign tmp_9_fu_589_p2 = (($signed(hin_2_reg_322) > $signed(16'd64)) ? 1'b1 : 1'b0);
...
assign wout_1_fu_881_p2 = (wout_mid_reg_932 + 7'd1);

assign wout_mid_fu_542_p3 = ((exitcond1_reg_252[0:0] === 1'b1) ? 7'd0 : wout_reg_287);

always @ (posedge ap_clk) begin
    tmp_4_cast_reg_916[15:7] <= 9'b000000000;
    tmp_24_cast_reg_956[63:13] <= 51'b000000000000000000000000000000000000000000000000000;
end
