...
(* CORE_GENERATION_INFO="conv_18,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.223500,HLS_SYN_LAT=2019339,HLS_SYN_TPT=none,HLS_SYN_MEM=1,HLS_SYN_DSP=1,HLS_SYN_FF=100,HLS_SYN_LUT=580}" *)
...
reg   [4:0] pout_reg_259;
wire   [8:0] indvar_flatten_next7_fu_281_p2;
reg   [8:0] indvar_flatten_next7_reg_572;
wire    ap_CS_fsm_state2;
wire   [5:0] init_idx_1_fu_293_p2;
reg    ap_block_state3;
reg  signed [15:0] tmp_V_reg_585;
wire   [6:0] indvar_flatten_next_fu_317_p2;
reg   [6:0] indvar_flatten_next_reg_590;
reg  signed [7:0] tmp_V_1_reg_595;
reg    ap_block_state5_pp0_stage0_iter0;
wire    ap_block_state6_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
reg   [4:0] out_val_V_addr_2_reg_600;
wire   [4:0] pout_1_fu_328_p2;
reg   [4:0] pout_1_reg_606;
wire   [0:0] exitcond7_fu_334_p2;
reg   [0:0] exitcond7_reg_611;
wire   [5:0] wr_idx_1_fu_547_p2;
reg   [5:0] wr_idx_1_reg_621;
...
reg   [8:0] indvar_flatten_reg_224;
wire    ap_CS_fsm_state1;
wire   [0:0] exitcond_flatten8_fu_558_p2;
reg   [5:0] init_idx_reg_236;
reg   [6:0] indvar_flatten1_reg_247;
wire    ap_CS_fsm_state7;
wire   [0:0] exitcond_flatten_fu_535_p2;
reg   [4:0] ap_phi_mux_pout_phi_fu_263_p4;
reg   [5:0] wr_idx_reg_270;
wire   [63:0] tmp_fu_299_p1;
wire   [63:0] tmp_s_fu_323_p1;
wire   [63:0] tmp_5_fu_553_p1;
wire   [8:0] tmp_2_fu_304_p3;
wire   [22:0] tmp_1_fu_346_p3;
wire  signed [23:0] tmp_10_cast_fu_354_p1;
...
wire   [0:0] tmp_12_fu_406_p3;
wire   [0:0] tmp_11_fu_392_p3;
wire   [0:0] tmp_7_fu_414_p2;
wire   [0:0] p_Result_2_not_fu_426_p2;
wire   [0:0] tmp_8_fu_363_p3;
wire   [0:0] not_carry_1_fu_432_p2;
wire   [0:0] carry_1_fu_420_p2;
...
wire   [15:0] p_Val2_5_9_fu_518_p3;
reg   [7:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
conv_18_mul_mul_1bkb #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 8 ),
    .dout_WIDTH( 24 ))
conv_18_mul_mul_1bkb_U1(
    .din0(tmp_V_reg_585),
    .din1(tmp_V_1_reg_595),
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten_fu_535_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state7))) begin
        indvar_flatten1_reg_247 <= indvar_flatten_next_reg_590;
    end else if ((~((exitcond3_fu_287_p2 == 1'd0) & (bias_V_V_empty_n == 1'b0)) & (exitcond3_fu_287_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        indvar_flatten1_reg_247 <= 7'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_flatten8_fu_558_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state8) & (exitcond_fu_541_p2 == 1'd1))) begin
        indvar_flatten_reg_224 <= indvar_flatten_next7_reg_572;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        indvar_flatten_reg_224 <= 9'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        init_idx_reg_236 <= 6'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state7) & (exitcond_flatten_fu_535_p2 == 1'd1))) begin
        wr_idx_reg_270 <= 6'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_V_1_reg_595 <= weight_V_V_dout;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        indvar_flatten_next7_reg_572 <= indvar_flatten_next7_fu_281_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (input_V_V_empty_n == 1'b1))) begin
        indvar_flatten_next_reg_590 <= indvar_flatten_next_fu_317_p2;
        tmp_V_reg_585 <= input_V_V_dout;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state8 : begin
            if (((1'b1 == ap_CS_fsm_state8) & (exitcond_flatten8_fu_558_p2 == 1'd1) & (exitcond_fu_541_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if (((exitcond_flatten8_fu_558_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state8) & (exitcond_fu_541_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
...
assign brmerge40_demorgan_i_fu_474_p2 = (tmp_8_fu_363_p3 & tmp_12_fu_406_p3);

assign brmerge_i_i_fu_462_p2 = (tmp_12_fu_406_p3 | p_not_i_i_fu_456_p2);

assign brmerge_i_i_i_fu_492_p2 = (underflow_fu_486_p2 | overflow_fu_468_p2);

assign carry_1_fu_420_p2 = (tmp_7_fu_414_p2 & tmp_11_fu_392_p3);

assign deleted_zeros_fu_438_p2 = (tmp_8_fu_363_p3 ^ not_carry_1_fu_432_p2);

assign exitcond3_fu_287_p2 = ((init_idx_reg_236 == 6'd32) ? 1'b1 : 1'b0);

assign exitcond7_fu_334_p2 = ((ap_phi_mux_pout_phi_fu_263_p4 == 5'd31) ? 1'b1 : 1'b0);

assign exitcond_flatten8_fu_558_p2 = ((indvar_flatten_reg_224 == 9'd440) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_535_p2 = ((indvar_flatten1_reg_247 == 7'd127) ? 1'b1 : 1'b0);

assign exitcond_fu_541_p2 = ((wr_idx_reg_270 == 6'd32) ? 1'b1 : 1'b0);

assign indvar_flatten_next7_fu_281_p2 = (indvar_flatten_reg_224 + 9'd1);

assign indvar_flatten_next_fu_317_p2 = (indvar_flatten1_reg_247 + 7'd1);

assign init_idx_1_fu_293_p2 = (init_idx_reg_236 + 6'd1);

assign not_carry_1_fu_432_p2 = (tmp_12_fu_406_p3 | p_Result_2_not_fu_426_p2);

assign out_val_V_d0 = $signed(tmp_2_fu_304_p3);

assign out_val_V_d1 = ((underflow_not_fu_504_p2[0:0] === 1'b1) ? p_Val2_5_mux_fu_510_p3 : p_Val2_5_9_fu_518_p3);

assign output_V_V_din = out_val_V_q1;

assign overflow_fu_468_p2 = (tmp_6_fu_444_p2 & brmerge_i_i_fu_462_p2);

assign p_38_i_i_fu_450_p2 = (tmp_8_fu_363_p3 & carry_1_fu_420_p2);

assign p_Result_2_not_fu_426_p2 = (tmp_11_fu_392_p3 ^ 1'd1);

assign p_Val2_3_fu_358_p2 = ($signed(tmp_10_cast_fu_354_p1) + $signed(p_Val2_2_fu_564_p2));

assign p_Val2_4_fu_371_p4 = {{p_Val2_3_fu_358_p2[22:7]}};

assign p_Val2_5_9_fu_518_p3 = ((underflow_fu_486_p2[0:0] === 1'b1) ? 16'd32768 : p_Val2_5_fu_400_p2);
...
assign pout_1_fu_328_p2 = (ap_phi_mux_pout_phi_fu_263_p4 + 5'd1);

assign tmp1_demorgan_fu_480_p2 = (p_38_i_i_fu_450_p2 | brmerge40_demorgan_i_fu_474_p2);

assign tmp2_fu_498_p2 = (tmp_6_fu_444_p2 | tmp_12_fu_406_p3);

assign tmp_10_cast_fu_354_p1 = $signed(tmp_1_fu_346_p3);

assign tmp_10_fu_381_p3 = p_Val2_2_fu_564_p2[32'd6];

assign tmp_11_fu_392_p3 = p_Val2_3_fu_358_p2[32'd22];

assign tmp_12_fu_406_p3 = p_Val2_5_fu_400_p2[32'd15];

assign tmp_1_fu_346_p3 = {{out_val_V_q0}, {7'd0}};

assign tmp_2_fu_304_p3 = {{bias_V_V_dout}, {1'd0}};

assign tmp_5_fu_553_p1 = wr_idx_reg_270;

assign tmp_6_fu_444_p2 = (tmp_8_fu_363_p3 ^ 1'd1);

assign tmp_7_fu_414_p2 = (tmp_12_fu_406_p3 ^ 1'd1);

assign tmp_8_fu_363_p3 = p_Val2_3_fu_358_p2[32'd23];

assign tmp_9_fu_388_p1 = tmp_10_fu_381_p3;

assign tmp_fu_299_p1 = init_idx_reg_236;

assign tmp_s_fu_323_p1 = ap_phi_mux_pout_phi_fu_263_p4;

assign underflow_fu_486_p2 = (tmp_8_fu_363_p3 ^ tmp1_demorgan_fu_480_p2);

assign underflow_not_fu_504_p2 = (tmp2_fu_498_p2 | p_38_i_i_fu_450_p2);

assign wr_idx_1_fu_547_p2 = (wr_idx_reg_270 + 6'd1);
