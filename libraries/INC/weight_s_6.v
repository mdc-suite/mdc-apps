...
(* CORE_GENERATION_INFO="weight_s_6,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.593250,HLS_SYN_LAT=37748738,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=108,HLS_SYN_LUT=826}" *)
...
reg   [19:0] indvar_flatten2_reg_137;
reg   [11:0] indvar_flatten3_reg_148;
reg   [1:0] hkern_reg_159;
reg   [10:0] indvar_flatten4_reg_170;
reg   [1:0] wkern_reg_181;
reg   [9:0] indvar_flatten_reg_192;
reg   [4:0] pkern_reg_203;
reg   [4:0] pout_reg_214;
...
wire   [4:0] tmp_4_mid2_fu_485_p3;
reg   [4:0] tmp_4_mid2_reg_657;
wire   [4:0] pout_1_fu_576_p2;
wire   [9:0] indvar_flatten_next_fu_588_p3;
wire   [10:0] indvar_flatten_next1_fu_602_p3;
wire   [11:0] indvar_flatten_next2_fu_616_p3;
wire   [19:0] indvar_flatten_next3_fu_630_p3;
wire    ap_CS_fsm_state1;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg   [1:0] ap_phi_mux_hkern_phi_fu_163_p4;
reg   [1:0] ap_phi_mux_wkern_phi_fu_185_p4;
reg   [4:0] ap_phi_mux_pkern_phi_fu_207_p4;
...
wire   [4:0] pkern_mid1_fu_415_p3;
wire   [0:0] exitcond_mid3_fu_447_p2;
wire   [0:0] tmp_4_fu_459_p2;
wire   [0:0] tmp_5_fu_465_p2;
wire   [0:0] tmp_6_fu_471_p2;
wire   [4:0] pkern_1_fu_453_p2;
wire   [4:0] pout_mid2_fu_477_p3;
wire   [8:0] tmp_7_fu_497_p3;
wire   [9:0] tmp_4_mid2_cast_fu_493_p1;
wire   [9:0] tmp_15_cast_fu_505_p1;
wire   [9:0] tmp_9_fu_509_p2;
wire   [11:0] tmp_10_fu_519_p3;
...
wire   [10:0] tmp_14_fu_547_p1;
wire   [12:0] p_shl_cast_fu_551_p3;
wire   [12:0] tmp_13_fu_543_p1;
wire   [12:0] tmp_2_mid2_cast_fu_431_p1;
wire   [12:0] tmp_15_fu_559_p2;
wire   [12:0] tmp_16_fu_565_p2;
wire   [9:0] indvar_flatten_op_fu_582_p2;
wire   [10:0] indvar_flatten13_op_fu_596_p2;
wire   [11:0] indvar_flatten37_op_fu_610_p2;
wire   [19:0] indvar_flatten71_op_fu_624_p2;
reg   [2:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
assign exitcond_flatten1_fu_261_p2 = ((indvar_flatten_reg_192 == 10'd256) ? 1'b1 : 1'b0);

assign exitcond_flatten2_fu_273_p2 = ((indvar_flatten4_reg_170 == 11'd768) ? 1'b1 : 1'b0);
...
assign exitcond_flatten3_fu_285_p2 = ((indvar_flatten3_reg_148 == 12'd2304) ? 1'b1 : 1'b0);

assign exitcond_flatten4_fu_225_p2 = ((indvar_flatten1_reg_126 == 26'd37748736) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_237_p2 = ((indvar_flatten2_reg_137 == 20'd294912) ? 1'b1 : 1'b0);
...
assign exitcond_fu_249_p2 = ((pout_reg_214 == 5'd16) ? 1'b1 : 1'b0);
...
assign indvar_flatten13_op_fu_596_p2 = (11'd1 + indvar_flatten4_reg_170);

assign indvar_flatten37_op_fu_610_p2 = (12'd1 + indvar_flatten3_reg_148);

assign indvar_flatten71_op_fu_624_p2 = (20'd1 + indvar_flatten2_reg_137);

assign indvar_flatten_next1_fu_602_p3 = ((tmp_fu_353_p2[0:0] === 1'b1) ? 11'd1 : indvar_flatten13_op_fu_596_p2);

assign indvar_flatten_next2_fu_616_p3 = ((tmp_3_fu_297_p2[0:0] === 1'b1) ? 12'd1 : indvar_flatten37_op_fu_610_p2);

assign indvar_flatten_next3_fu_630_p3 = ((exitcond_flatten_fu_237_p2[0:0] === 1'b1) ? 20'd1 : indvar_flatten71_op_fu_624_p2);

assign indvar_flatten_next4_fu_231_p2 = (indvar_flatten1_reg_126 + 26'd1);

assign indvar_flatten_next_fu_588_p3 = ((tmp_2_fu_409_p2[0:0] === 1'b1) ? 10'd1 : indvar_flatten_op_fu_582_p2);

assign indvar_flatten_op_fu_582_p2 = (10'd1 + indvar_flatten_reg_192);
...
assign pkern_1_fu_453_p2 = (5'd1 + pkern_mid1_fu_415_p3);

assign pkern_mid1_fu_415_p3 = ((tmp_2_fu_409_p2[0:0] === 1'b1) ? 5'd0 : ap_phi_mux_pkern_phi_fu_207_p4);

assign pout_1_fu_576_p2 = (5'd1 + pout_mid2_fu_477_p3);

assign pout_mid2_fu_477_p3 = ((tmp_6_fu_471_p2[0:0] === 1'b1) ? 5'd0 : pout_reg_214);
...
assign tmp_13_fu_543_p1 = tmp_12_fu_537_p2[12:0];

assign tmp_14_fu_547_p1 = tmp_12_fu_537_p2[10:0];
...
assign tmp_7_fu_497_p3 = {{pout_mid2_fu_477_p3}, {4'd0}};
