...
(* CORE_GENERATION_INFO="weight_s_12,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.513250,HLS_SYN_LAT=18874370,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=111,HLS_SYN_LUT=829}" *)
...
reg   [12:0] indvar_flatten3_reg_152;
reg   [1:0] hkern_reg_163;
reg   [11:0] indvar_flatten4_reg_174;
reg   [1:0] wkern_reg_185;
reg   [10:0] indvar_flatten_reg_196;
reg   [4:0] pkern_reg_207;
reg   [5:0] pout_reg_218;
...
wire   [4:0] tmp_4_mid2_fu_489_p3;
reg   [4:0] tmp_4_mid2_reg_661;
wire   [5:0] pout_1_fu_580_p2;
wire   [10:0] indvar_flatten_next_fu_592_p3;
wire   [11:0] indvar_flatten_next1_fu_606_p3;
wire   [12:0] indvar_flatten_next2_fu_620_p3;
...
reg   [4:0] ap_phi_mux_pkern_phi_fu_211_p4;
...
wire   [4:0] pkern_mid1_fu_419_p3;
wire   [0:0] exitcond_mid3_fu_451_p2;
wire   [0:0] tmp_4_fu_463_p2;
wire   [0:0] tmp_5_fu_469_p2;
wire   [0:0] tmp_6_fu_475_p2;
wire   [4:0] pkern_1_fu_457_p2;
wire   [5:0] pout_mid2_fu_481_p3;
wire   [9:0] tmp_7_fu_501_p3;
wire   [10:0] tmp_4_mid2_cast_fu_497_p1;
wire   [10:0] tmp_15_cast_fu_509_p1;
wire   [10:0] tmp_9_fu_513_p2;
wire   [12:0] tmp_10_fu_523_p3;
...
wire   [11:0] tmp_14_fu_551_p1;
wire   [13:0] p_shl_cast_fu_555_p3;
wire   [13:0] tmp_13_fu_547_p1;
wire   [13:0] tmp_2_mid2_cast_fu_435_p1;
wire   [13:0] tmp_15_fu_563_p2;
wire   [13:0] tmp_16_fu_569_p2;
wire   [10:0] indvar_flatten_op_fu_586_p2;
wire   [11:0] indvar_flatten13_op_fu_600_p2;
wire   [12:0] indvar_flatten37_op_fu_614_p2;
...
assign exitcond_flatten1_fu_265_p2 = ((indvar_flatten_reg_196 == 11'd512) ? 1'b1 : 1'b0);

assign exitcond_flatten2_fu_277_p2 = ((indvar_flatten4_reg_174 == 12'd1536) ? 1'b1 : 1'b0);
...
assign exitcond_flatten3_fu_289_p2 = ((indvar_flatten3_reg_152 == 13'd4608) ? 1'b1 : 1'b0);

assign exitcond_flatten4_fu_229_p2 = ((indvar_flatten1_reg_130 == 25'd18874368) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_241_p2 = ((indvar_flatten2_reg_141 == 20'd294912) ? 1'b1 : 1'b0);
...
assign exitcond_fu_253_p2 = ((pout_reg_218 == 6'd32) ? 1'b1 : 1'b0);
...
assign indvar_flatten13_op_fu_600_p2 = (12'd1 + indvar_flatten4_reg_174);

assign indvar_flatten37_op_fu_614_p2 = (13'd1 + indvar_flatten3_reg_152);

assign indvar_flatten71_op_fu_628_p2 = (20'd1 + indvar_flatten2_reg_141);

assign indvar_flatten_next1_fu_606_p3 = ((tmp_fu_357_p2[0:0] === 1'b1) ? 12'd1 : indvar_flatten13_op_fu_600_p2);

assign indvar_flatten_next2_fu_620_p3 = ((tmp_3_fu_301_p2[0:0] === 1'b1) ? 13'd1 : indvar_flatten37_op_fu_614_p2);
...
assign indvar_flatten_next_fu_592_p3 = ((tmp_2_fu_413_p2[0:0] === 1'b1) ? 11'd1 : indvar_flatten_op_fu_586_p2);

assign indvar_flatten_op_fu_586_p2 = (11'd1 + indvar_flatten_reg_196);
...
assign pkern_1_fu_457_p2 = (5'd1 + pkern_mid1_fu_419_p3);

assign pkern_mid1_fu_419_p3 = ((tmp_2_fu_413_p2[0:0] === 1'b1) ? 5'd0 : ap_phi_mux_pkern_phi_fu_211_p4);

assign pout_1_fu_580_p2 = (6'd1 + pout_mid2_fu_481_p3);

assign pout_mid2_fu_481_p3 = ((tmp_6_fu_475_p2[0:0] === 1'b1) ? 6'd0 : pout_reg_218);
...
assign tmp_13_fu_547_p1 = tmp_12_fu_541_p2[13:0];

assign tmp_14_fu_551_p1 = tmp_12_fu_541_p2[11:0];
...
assign tmp_7_fu_501_p3 = {{pout_mid2_fu_481_p3}, {4'd0}};
