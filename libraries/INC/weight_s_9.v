...
(* CORE_GENERATION_INFO="weight_s_9,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.193125,HLS_SYN_LAT=4194306,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=91,HLS_SYN_LUT=638}" *)
...
reg   [22:0] indvar_flatten1_reg_112;
reg   [17:0] indvar_flatten2_reg_123;
reg   [11:0] indvar_flatten3_reg_134;
reg   [0:0] wkern_reg_145;
reg   [11:0] indvar_flatten_reg_156;
reg   [6:0] pkern_reg_167;
reg   [4:0] pout_reg_178;
wire   [0:0] exitcond_flatten3_fu_189_p2;
wire    ap_block_state2_pp0_stage0_iter0;
reg    ap_block_state3_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [22:0] indvar_flatten_next3_fu_195_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] wkern_mid2_fu_353_p3;
wire   [6:0] tmp_4_mid2_fu_387_p3;
reg   [6:0] tmp_4_mid2_reg_490;
wire   [4:0] pout_1_fu_428_p2;
wire   [11:0] indvar_flatten_next_fu_440_p3;
wire   [11:0] indvar_flatten_next1_fu_454_p3;
wire   [17:0] indvar_flatten_next2_fu_468_p3;
wire    ap_CS_fsm_state1;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg   [6:0] ap_phi_mux_pkern_phi_fu_171_p4;
...
wire   [6:0] pkern_mid1_fu_321_p3;
wire   [0:0] exitcond_mid2_fu_347_p2;
wire   [0:0] tmp_7_fu_367_p2;
wire   [0:0] tmp_3_fu_373_p2;
wire   [6:0] pkern_1_fu_361_p2;
wire   [4:0] pout_mid2_fu_379_p3;
wire   [10:0] tmp_8_fu_399_p3;
wire   [11:0] tmp_4_mid2_cast_fu_395_p1;
wire   [11:0] tmp_9_cast_fu_407_p1;
wire   [11:0] tmp_2_mid2_cast_fu_337_p1;
wire   [11:0] tmp_s_fu_411_p2;
wire   [11:0] tmp_4_fu_417_p2;
wire   [11:0] indvar_flatten_op_fu_434_p2;
wire   [11:0] indvar_flatten13_op_fu_448_p2;
...
assign exitcond_flatten1_fu_231_p2 = ((indvar_flatten_reg_156 == 12'd1024) ? 1'b1 : 1'b0);

assign exitcond_flatten2_fu_243_p2 = ((indvar_flatten3_reg_134 == 12'd1024) ? 1'b1 : 1'b0);

assign exitcond_flatten3_fu_189_p2 = ((indvar_flatten1_reg_112 == 23'd4194304) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_201_p2 = ((indvar_flatten2_reg_123 == 18'd65536) ? 1'b1 : 1'b0);
...
assign indvar_flatten13_op_fu_448_p2 = (indvar_flatten3_reg_134 + 12'd1);

assign indvar_flatten37_op_fu_462_p2 = (indvar_flatten2_reg_123 + 18'd1);

assign indvar_flatten_next1_fu_454_p3 = ((tmp_1_fu_273_p2[0:0] === 1'b1) ? 12'd1 : indvar_flatten13_op_fu_448_p2);

assign indvar_flatten_next2_fu_468_p3 = ((exitcond_flatten_fu_201_p2[0:0] === 1'b1) ? 18'd1 : indvar_flatten37_op_fu_462_p2);

assign indvar_flatten_next3_fu_195_p2 = (indvar_flatten1_reg_112 + 23'd1);

assign indvar_flatten_next_fu_440_p3 = ((tmp_2_fu_315_p2[0:0] === 1'b1) ? 12'd1 : indvar_flatten_op_fu_434_p2);

assign indvar_flatten_op_fu_434_p2 = (indvar_flatten_reg_156 + 12'd1);
...
assign pkern_1_fu_361_p2 = (pkern_mid1_fu_321_p3 + 7'd1);

assign pkern_mid1_fu_321_p3 = ((tmp_2_fu_315_p2[0:0] === 1'b1) ? 7'd0 : ap_phi_mux_pkern_phi_fu_171_p4);
...
assign tmp_8_fu_399_p3 = {{pout_mid2_fu_379_p3}, {6'd0}};
