...
(* CORE_GENERATION_INFO="line_buffer_mp_2,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.690000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=21,HLS_SYN_DSP=0,HLS_SYN_FF=331,HLS_SYN_LUT=1058}" *)
...
wire   [1:0] wkern_1_fu_821_p2;
reg   [1:0] wkern_1_reg_1017;
wire   [3:0] indvar_flatten_next_fu_833_p3;
reg   [3:0] indvar_flatten_next_reg_1022;
wire   [9:0] indvar_flatten_next2_fu_841_p2;
reg   [9:0] indvar_flatten_next2_reg_1027;
...
wire   [12:0] tmp_22_fu_765_p3;
wire   [7:0] tmp_23_fu_777_p3;
wire   [13:0] p_shl5_cast_fu_785_p1;
wire   [13:0] p_shl4_cast_fu_773_p1;
wire   [1:0] wkern_mid2_fu_749_p3;
wire   [6:0] tmp_27_cast_fu_795_p1;
wire   [6:0] col_assign_fu_799_p2;
wire   [13:0] tmp_24_fu_789_p2;
wire   [13:0] tmp_22_cast_fu_804_p1;
wire   [13:0] tmp_25_fu_808_p2;
wire   [3:0] indvar_flatten_op_fu_827_p2;
reg   [8:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
reg    ap_idle_pp1;
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten2_reg_1042 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        hkern_reg_444 <= hkern_mid2_reg_996;
    end else if (((1'b1 == ap_CS_fsm_state7) & ((or_cond_reg_934 == 1'd0) | ((tmp_12_fu_679_p2 == 1'd0) & (tmp_15_fu_692_p2 == 1'd1))))) begin
        hkern_reg_444 <= 2'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten2_reg_1042 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        pout_reg_466 <= pout_mid2_reg_991;
    end else if (((1'b1 == ap_CS_fsm_state7) & ((or_cond_reg_934 == 1'd0) | ((tmp_12_fu_679_p2 == 1'd0) & (tmp_15_fu_692_p2 == 1'd1))))) begin
        pout_reg_466 <= 7'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten2_reg_1042 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        wkern_reg_433 <= wkern_1_reg_1017;
    end else if (((1'b1 == ap_CS_fsm_state7) & ((or_cond_reg_934 == 1'd0) | ((tmp_12_fu_679_p2 == 1'd0) & (tmp_15_fu_692_p2 == 1'd1))))) begin
        wkern_reg_433 <= 2'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        tmp_24_cast_reg_952[13 : 0] <= tmp_24_cast_fu_667_p1[13 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        ...
        tmp_4_cast_reg_912[6 : 0] <= tmp_4_cast_fu_524_p1[6 : 0];
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (exitcond_flatten2_reg_1042 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ap_phi_mux_hkern_phi_fu_448_p4 = hkern_mid2_reg_996;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (exitcond_flatten2_reg_1042 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ap_phi_mux_pout_phi_fu_470_p4 = pout_mid2_reg_991;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (exitcond_flatten2_reg_1042 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ap_phi_mux_wkern_phi_fu_437_p4 = wkern_1_reg_1017;
    end else begin
...
assign exitcond_flatten1_fu_888_p2 = ((indvar_flatten_reg_306 == 12'd4095) ? 1'b1 : 1'b0);

assign exitcond_flatten2_fu_859_p2 = ((ap_phi_mux_indvar_flatten2_phi_fu_481_p4 == 10'd575) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_853_p2 = ((indvar_flatten_next_fu_833_p3 == 4'd9) ? 1'b1 : 1'b0);

assign exitcond_fu_847_p2 = ((wkern_1_fu_821_p2 == 2'd3) ? 1'b1 : 1'b0);
...
assign indvar_flatten_next2_fu_841_p2 = (ap_phi_mux_indvar_flatten2_phi_fu_481_p4 + 10'd1);

assign indvar_flatten_next_fu_833_p3 = ((ap_phi_mux_exitcond_flatten3_phi_fu_415_p4[0:0] === 1'b1) ? 4'd1 : indvar_flatten_op_fu_827_p2);

assign indvar_flatten_op_fu_827_p2 = (ap_phi_mux_indvar_flatten1_phi_fu_459_p4 + 4'd1);
...
assign tmp_22_fu_765_p3 = {{pout_mid2_fu_729_p3}, {6'd0}};

assign tmp_23_fu_777_p3 = {{pout_mid2_fu_729_p3}, {1'd0}};
...
assign tmp_27_cast_fu_795_p1 = wkern_mid2_fu_749_p3;
...
assign wkern_1_fu_821_p2 = (wkern_mid2_fu_749_p3 + 2'd1);
...
always @ (posedge ap_clk) begin
    ...
    tmp_24_cast_reg_952[63:14] <= 50'b00000000000000000000000000000000000000000000000000;
end
