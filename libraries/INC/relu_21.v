...
(* CORE_GENERATION_INFO="relu_21,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.258000,HLS_SYN_LAT=897,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=21,HLS_SYN_LUT=175}" *)
...
wire   [2:0] i_1_fu_104_p2;
reg   [2:0] i_1_reg_160;
wire    ap_CS_fsm_state2;
wire   [2:0] j_1_fu_116_p2;
reg   [2:0] j_1_reg_168;
wire    ap_CS_fsm_state3;
wire   [4:0] k_1_fu_128_p2;
reg    ap_block_state4;
reg   [2:0] i_reg_65;
...
assign exitcond1_fu_98_p2 = ((i_reg_65 == 3'd7) ? 1'b1 : 1'b0);

assign exitcond2_fu_110_p2 = ((j_reg_76 == 3'd7) ? 1'b1 : 1'b0);

assign exitcond_fu_122_p2 = ((k_reg_87 == 5'd16) ? 1'b1 : 1'b0);

assign i_1_fu_104_p2 = (i_reg_65 + 3'd1);

assign j_1_fu_116_p2 = (j_reg_76 + 3'd1);

assign k_1_fu_128_p2 = (k_reg_87 + 5'd1);
