...
(* CORE_GENERATION_INFO="weight_s_5,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.740000,HLS_SYN_LAT=40534273,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=74,HLS_SYN_LUT=342}" *)
...
reg   [7:0] hout_1_reg_331;
wire    ap_CS_fsm_state2;
wire   [7:0] wout_1_fu_186_p2;
reg   [7:0] wout_1_reg_339;
...
wire   [11:0] tmp_s_fu_312_p2;
wire   [11:0] tmp_6_fu_318_p2;
reg   [7:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((exitcond7_fu_224_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
        tmp_4_cast_reg_378[3 : 0] <= tmp_4_cast_fu_236_p1[3 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    ...
    tmp_2_cast_reg_365[11:2] <= 10'b0000000000;
    tmp_4_cast_reg_378[8:4] <= 5'b00000;
end
