...
(* CORE_GENERATION_INFO="weight_s_1,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.395250,HLS_SYN_LAT=786434,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=64,HLS_SYN_LUT=589}" *)
...
reg   [19:0] indvar_flatten1_reg_110;
reg   [13:0] indvar_flatten2_reg_121;
reg   [6:0] indvar_flatten3_reg_132;
reg   [0:0] wkern_reg_143;
reg   [6:0] indvar_flatten_reg_154;
reg   [1:0] pkern_reg_165;
reg   [4:0] pout_reg_176;
wire   [0:0] exitcond_flatten3_fu_187_p2;
wire    ap_block_state2_pp0_stage0_iter0;
reg    ap_block_state3_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [19:0] indvar_flatten_next3_fu_193_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] wkern_mid2_fu_351_p3;
wire   [1:0] tmp_4_mid2_fu_385_p3;
reg   [1:0] tmp_4_mid2_reg_494;
wire   [4:0] pout_1_fu_432_p2;
wire   [6:0] indvar_flatten_next_fu_444_p3;
wire   [6:0] indvar_flatten_next1_fu_458_p3;
wire   [13:0] indvar_flatten_next2_fu_472_p3;
...
wire   [4:0] pout_mid2_fu_377_p3;
wire   [6:0] tmp_9_fu_401_p3;
wire   [6:0] tmp_6_cast_fu_397_p1;
wire   [6:0] tmp_s_fu_409_p2;
wire   [6:0] tmp_4_mid2_cast_fu_393_p1;
wire   [6:0] tmp_4_fu_415_p2;
wire   [6:0] tmp_2_mid2_cast_fu_335_p1;
wire   [6:0] tmp_6_fu_421_p2;
wire   [6:0] indvar_flatten_op_fu_438_p2;
wire   [6:0] indvar_flatten13_op_fu_452_p2;
wire   [13:0] indvar_flatten37_op_fu_466_p2;
reg   [2:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
assign exitcond_flatten1_fu_229_p2 = ((indvar_flatten_reg_154 == 7'd48) ? 1'b1 : 1'b0);

assign exitcond_flatten2_fu_241_p2 = ((indvar_flatten3_reg_132 == 7'd48) ? 1'b1 : 1'b0);

assign exitcond_flatten3_fu_187_p2 = ((indvar_flatten1_reg_110 == 20'd786432) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_199_p2 = ((indvar_flatten2_reg_121 == 14'd6144) ? 1'b1 : 1'b0);
...
assign exitcond_fu_217_p2 = ((pout_reg_176 == 5'd16) ? 1'b1 : 1'b0);
...
assign indvar_flatten13_op_fu_452_p2 = (indvar_flatten3_reg_132 + 7'd1);

assign indvar_flatten37_op_fu_466_p2 = (indvar_flatten2_reg_121 + 14'd1);

assign indvar_flatten_next1_fu_458_p3 = ((tmp_1_fu_271_p2[0:0] === 1'b1) ? 7'd1 : indvar_flatten13_op_fu_452_p2);

assign indvar_flatten_next2_fu_472_p3 = ((exitcond_flatten_fu_199_p2[0:0] === 1'b1) ? 14'd1 : indvar_flatten37_op_fu_466_p2);

assign indvar_flatten_next3_fu_193_p2 = (indvar_flatten1_reg_110 + 20'd1);

assign indvar_flatten_next_fu_444_p3 = ((tmp_2_fu_313_p2[0:0] === 1'b1) ? 7'd1 : indvar_flatten_op_fu_438_p2);

assign indvar_flatten_op_fu_438_p2 = (indvar_flatten_reg_154 + 7'd1);
...
assign pout_1_fu_432_p2 = (pout_mid2_fu_377_p3 + 5'd1);

assign pout_mid2_fu_377_p3 = ((tmp_3_fu_371_p2[0:0] === 1'b1) ? 5'd0 : pout_reg_176);
