...
(* CORE_GENERATION_INFO="bias_s_4,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.515000,HLS_SYN_LAT=295169,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=45,HLS_SYN_LUT=148}" *)
...
wire   [3:0] init_idx_1_fu_131_p2;
reg   [3:0] init_idx_1_reg_161;
...
assign exitcond_fu_125_p2 = ((init_idx_reg_90 == 4'd8) ? 1'b1 : 1'b0);

assign hout_1_fu_107_p2 = (hout_reg_68 + 8'd1);

assign init_idx_1_fu_131_p2 = (init_idx_reg_90 + 4'd1);
