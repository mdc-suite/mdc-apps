...
(* CORE_GENERATION_INFO="conv_20,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.783500,HLS_SYN_LAT=17105067,HLS_SYN_TPT=none,HLS_SYN_MEM=1,HLS_SYN_DSP=1,HLS_SYN_FF=112,HLS_SYN_LUT=584}" *)
...
reg   [5:0] pout_reg_259;
wire   [8:0] indvar_flatten_next_fu_281_p2;
reg   [8:0] indvar_flatten_next_reg_572;
wire    ap_CS_fsm_state2;
wire   [6:0] init_idx_1_fu_293_p2;
reg    ap_block_state3;
reg  signed [15:0] tmp_V_3_reg_585;
wire   [9:0] indvar_flatten_next1_fu_317_p2;
reg   [9:0] indvar_flatten_next1_reg_590;
reg  signed [7:0] tmp_V_2_reg_595;
reg    ap_block_state5_pp0_stage0_iter0;
wire    ap_block_state6_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
reg   [5:0] out_val_V_addr_2_reg_600;
wire   [5:0] pout_1_fu_328_p2;
reg   [5:0] pout_1_reg_606;
wire   [0:0] exitcond7_fu_334_p2;
reg   [0:0] exitcond7_reg_611;
wire   [6:0] wr_idx_1_fu_547_p2;
reg   [6:0] wr_idx_1_reg_621;
...
reg   [6:0] init_idx_reg_236;
reg   [9:0] indvar_flatten1_reg_247;
wire    ap_CS_fsm_state7;
wire   [0:0] exitcond_flatten1_fu_535_p2;
reg   [5:0] ap_phi_mux_pout_phi_fu_263_p4;
reg   [6:0] wr_idx_reg_270;
...
assign exitcond3_fu_287_p2 = ((init_idx_reg_236 == 7'd64) ? 1'b1 : 1'b0);

assign exitcond7_fu_334_p2 = ((ap_phi_mux_pout_phi_fu_263_p4 == 6'd63) ? 1'b1 : 1'b0);

assign exitcond_flatten1_fu_535_p2 = ((indvar_flatten1_reg_247 == 10'd575) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_558_p2 = ((indvar_flatten_reg_224 == 9'd440) ? 1'b1 : 1'b0);

assign exitcond_fu_541_p2 = ((wr_idx_reg_270 == 7'd64) ? 1'b1 : 1'b0);

assign indvar_flatten_next1_fu_317_p2 = (indvar_flatten1_reg_247 + 10'd1);

assign indvar_flatten_next_fu_281_p2 = (indvar_flatten_reg_224 + 9'd1);

assign init_idx_1_fu_293_p2 = (init_idx_reg_236 + 7'd1);
...
assign pout_1_fu_328_p2 = (ap_phi_mux_pout_phi_fu_263_p4 + 6'd1);
...
assign wr_idx_1_fu_547_p2 = (wr_idx_reg_270 + 7'd1);
