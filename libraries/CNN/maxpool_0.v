...
(* CORE_GENERATION_INFO="maxpool_0,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.433000,HLS_SYN_LAT=868609,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=66,HLS_SYN_LUT=290}" *)
...
wire   [7:0] hout_1_fu_183_p2;
reg   [7:0] hout_1_reg_273;
wire    ap_CS_fsm_state2;
wire   [7:0] wout_1_fu_195_p2;
reg   [7:0] wout_1_reg_281;
wire    ap_CS_fsm_state3;
wire   [1:0] pout_1_fu_207_p2;
reg   [1:0] pout_1_reg_289;
...
assign exitcond1_fu_177_p2 = ((hout_reg_93 == 8'd128) ? 1'b1 : 1'b0);

assign exitcond2_fu_189_p2 = ((wout_reg_104 == 8'd128) ? 1'b1 : 1'b0);

assign exitcond3_fu_201_p2 = ((pout_reg_115 == 2'd3) ? 1'b1 : 1'b0);

assign exitcond4_fu_213_p2 = ((hkern_reg_126 == 2'd3) ? 1'b1 : 1'b0);

assign exitcond_fu_225_p2 = ((wkern_reg_149 == 2'd3) ? 1'b1 : 1'b0);

assign hkern_1_fu_219_p2 = (hkern_reg_126 + 2'd1);

assign hout_1_fu_183_p2 = (hout_reg_93 + 8'd1);
