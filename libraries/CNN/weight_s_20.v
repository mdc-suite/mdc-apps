...
(* CORE_GENERATION_INFO="weight_s_20,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.436500,HLS_SYN_LAT=33033589,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=75,HLS_SYN_LUT=334}" *)
...
reg   [4:0] hout_1_reg_323;
wire    ap_CS_fsm_state2;
wire   [4:0] wout_1_fu_178_p2;
reg   [4:0] wout_1_reg_331;
...
wire   [16:0] tmp_s_fu_304_p2;
wire   [16:0] tmp_6_fu_310_p2;
reg   [7:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((exitcond7_fu_216_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
        tmp_4_cast_reg_370[6 : 0] <= tmp_4_cast_fu_228_p1[6 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    ...
    tmp_2_cast_reg_357[16:2] <= 15'b000000000000000;
    tmp_4_cast_reg_370[13:7] <= 7'b0000000;
end
