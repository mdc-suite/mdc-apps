...
(* CORE_GENERATION_INFO="relu_11,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.433000,HLS_SYN_LAT=139393,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=58,HLS_SYN_LUT=192}" *)
...
assign exitcond_fu_144_p2 = ((k_reg_109 == 5'd16) ? 1'b1 : 1'b0);

assign i_1_fu_126_p2 = (i_reg_87 + 7'd1);

assign j_1_fu_138_p2 = (j_reg_98 + 7'd1);

assign k_1_fu_150_p2 = (k_reg_109 + 5'd1);
