...
(* CORE_GENERATION_INFO="bias_s_21,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.515000,HLS_SYN_LAT=1681,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=27,HLS_SYN_LUT=135}" *)
...
wire   [2:0] hout_1_fu_107_p2;
reg   [2:0] hout_1_reg_145;
wire    ap_CS_fsm_state2;
wire   [2:0] wout_1_fu_119_p2;
reg   [2:0] wout_1_reg_153;
...
assign exitcond2_fu_113_p2 = ((wout_reg_79 == 3'd7) ? 1'b1 : 1'b0);

assign exitcond3_fu_101_p2 = ((hout_reg_68 == 3'd7) ? 1'b1 : 1'b0);

assign exitcond_fu_125_p2 = ((init_idx_reg_90 == 5'd16) ? 1'b1 : 1'b0);

assign hout_1_fu_107_p2 = (hout_reg_68 + 3'd1);
...
assign wout_1_fu_119_p2 = (wout_reg_79 + 3'd1);
