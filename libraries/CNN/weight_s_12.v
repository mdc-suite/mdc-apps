...
(* CORE_GENERATION_INFO="weight_s_12,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.098500,HLS_SYN_LAT=57909377,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=102,HLS_SYN_LUT=324}" *)
...
reg   [6:0] hout_1_reg_329;
wire    ap_CS_fsm_state2;
wire   [6:0] wout_1_fu_186_p2;
reg   [6:0] wout_1_reg_337;
...
wire   [13:0] tmp_s_fu_311_p2;
wire   [13:0] tmp_6_fu_316_p2;
reg   [8:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((exitcond7_fu_224_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
        tmp_4_cast_reg_376[4 : 0] <= tmp_4_cast_fu_236_p1[4 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    ...
    tmp_2_cast_reg_363[13:2] <= 12'b000000000000;
    tmp_4_cast_reg_376[10:5] <= 6'b000000;
end
