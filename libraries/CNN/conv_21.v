...
(* CORE_GENERATION_INFO="conv_21,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.855000,HLS_SYN_LAT=265923,HLS_SYN_TPT=none,HLS_SYN_MEM=1,HLS_SYN_DSP=1,HLS_SYN_FF=200,HLS_SYN_LUT=586}" *)
...
wire   [5:0] indvar_flatten_next7_fu_282_p2;
reg   [5:0] indvar_flatten_next7_reg_557;
wire    ap_CS_fsm_state2;
wire   [4:0] init_idx_1_fu_294_p2;
reg    ap_block_state3;
reg  signed [15:0] tmp_V_reg_570;
wire   [7:0] indvar_flatten_next_fu_318_p2;
reg   [7:0] indvar_flatten_next_reg_575;
...
reg   [5:0] indvar_flatten_reg_225;
...
assign exitcond_flatten8_fu_544_p2 = ((indvar_flatten_reg_225 == 6'd48) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_521_p2 = ((indvar_flatten1_reg_248 == 8'd255) ? 1'b1 : 1'b0);

assign exitcond_fu_527_p2 = ((wr_idx_reg_271 == 5'd16) ? 1'b1 : 1'b0);

assign indvar_flatten_next7_fu_282_p2 = (indvar_flatten_reg_225 + 6'd1);

assign indvar_flatten_next_fu_318_p2 = (indvar_flatten1_reg_248 + 8'd1);
