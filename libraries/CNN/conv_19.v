...
(* CORE_GENERATION_INFO="conv_19,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.576500,HLS_SYN_LAT=8849547,HLS_SYN_TPT=none,HLS_SYN_MEM=1,HLS_SYN_DSP=1,HLS_SYN_FF=221,HLS_SYN_LUT=596}" *)
...
reg   [8:0] indvar_flatten_next_reg_552;
wire    ap_CS_fsm_state2;
wire   [6:0] init_idx_1_fu_288_p2;
reg    ap_block_state3;
reg  signed [15:0] tmp_V_3_reg_565;
wire   [8:0] indvar_flatten_next1_fu_312_p2;
reg   [8:0] indvar_flatten_next1_reg_570;
reg  signed [7:0] tmp_V_2_reg_575;
...
reg   [0:0] signbit_reg_605;
wire   [0:0] tmp_10_fu_386_p3;
reg   [0:0] tmp_10_reg_613;
wire   [15:0] p_Val2_5_fu_394_p2;
reg   [15:0] p_Val2_5_reg_618;
wire   [0:0] newsignbit_fu_400_p3;
reg   [0:0] newsignbit_reg_624;
...
wire   [0:0] exitcond_flatten_fu_539_p2;
reg   [6:0] init_idx_reg_231;
reg   [8:0] indvar_flatten1_reg_242;
...
wire   [0:0] carry_fu_414_p2;
wire   [0:0] p_Result_2_not_fu_426_p2;
wire   [0:0] not_carry_fu_431_p2;
...
wire   [15:0] p_Val2_5_7_fu_500_p3;
reg   [7:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
conv_19_mul_mul_1bkb_U1(
    .din0(tmp_V_3_reg_565),
    .din1(tmp_V_2_reg_575),
...
always @ (posedge ap_clk) begin
    if ((~((exitcond3_fu_282_p2 == 1'd0) & (bias_V_V_empty_n == 1'b0)) & (exitcond3_fu_282_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        indvar_flatten1_reg_242 <= 9'd0;
    end else if (((exitcond_flatten1_fu_516_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state9))) begin
        indvar_flatten1_reg_242 <= indvar_flatten_next1_reg_570;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_flatten_fu_539_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state10) & (exitcond_fu_522_p2 == 1'd1))) begin
        indvar_flatten_reg_219 <= indvar_flatten_next_reg_552;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state9) & (exitcond_flatten1_fu_516_p2 == 1'd1))) begin
        wr_idx_reg_265 <= 7'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        tmp_7_reg_600 <= p_Val2_2_fu_545_p2[32'd6];
        tmp_V_2_reg_575 <= weight_V_V_dout;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        newsignbit_reg_624 <= p_Val2_5_fu_394_p2[32'd15];
        p_38_i_i_reg_632 <= p_38_i_i_fu_420_p2;
        p_Val2_5_reg_618 <= p_Val2_5_fu_394_p2;
        signbit_reg_605 <= p_Val2_3_fu_360_p2[32'd23];
        tmp_10_reg_613 <= p_Val2_3_fu_360_p2[32'd22];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (input_V_V_empty_n == 1'b1))) begin
        indvar_flatten_next1_reg_570 <= indvar_flatten_next1_fu_312_p2;
        tmp_V_3_reg_565 <= input_V_V_dout;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        indvar_flatten_next_reg_552 <= indvar_flatten_next_fu_276_p2;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state10 : begin
            if (((1'b1 == ap_CS_fsm_state10) & (exitcond_flatten_fu_539_p2 == 1'd1) & (exitcond_fu_522_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if (((exitcond_flatten_fu_539_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state10) & (exitcond_fu_522_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
...
assign brmerge40_demorgan_i_fu_463_p2 = (signbit_reg_605 & newsignbit_reg_624);

assign brmerge_i_i_fu_452_p2 = (p_not_i_i_fu_446_p2 | newsignbit_reg_624);

assign brmerge_i_i_i_fu_477_p2 = (underflow_fu_472_p2 | overflow_fu_457_p2);

assign carry_fu_414_p2 = (tmp_6_fu_408_p2 & tmp_10_fu_386_p3);

assign deleted_zeros_fu_436_p2 = (signbit_reg_605 ^ not_carry_fu_431_p2);
...
assign exitcond_flatten1_fu_516_p2 = ((indvar_flatten1_reg_242 == 9'd287) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_539_p2 = ((indvar_flatten_reg_219 == 9'd440) ? 1'b1 : 1'b0);

assign exitcond_fu_522_p2 = ((wr_idx_reg_265 == 7'd64) ? 1'b1 : 1'b0);

assign indvar_flatten_next1_fu_312_p2 = (indvar_flatten1_reg_242 + 9'd1);

assign indvar_flatten_next_fu_276_p2 = (indvar_flatten_reg_219 + 9'd1);

assign init_idx_1_fu_288_p2 = (init_idx_reg_231 + 7'd1);

assign newsignbit_fu_400_p3 = p_Val2_5_fu_394_p2[32'd15];

assign not_carry_fu_431_p2 = (p_Result_2_not_fu_426_p2 | newsignbit_reg_624);

assign out_val_V_d0 = $signed(tmp_2_fu_299_p3);

assign out_val_V_d1 = ((underflow_not_fu_488_p2[0:0] === 1'b1) ? p_Val2_5_mux_fu_493_p3 : p_Val2_5_7_fu_500_p3);

assign output_V_V_din = out_val_V_q1;

assign overflow_fu_457_p2 = (tmp_8_fu_441_p2 & brmerge_i_i_fu_452_p2);

assign p_38_i_i_fu_420_p2 = (signbit_fu_365_p3 & carry_fu_414_p2);

assign p_Result_2_not_fu_426_p2 = (tmp_10_reg_613 ^ 1'd1);

assign p_Val2_3_fu_360_p2 = ($signed(tmp_4_cast_fu_356_p1) + $signed(p_Val2_2_reg_595));

assign p_Val2_4_fu_373_p4 = {{p_Val2_3_fu_360_p2[22:7]}};

assign p_Val2_5_7_fu_500_p3 = ((underflow_fu_472_p2[0:0] === 1'b1) ? 16'd32768 : p_Val2_5_reg_618);
...
assign tmp2_fu_483_p2 = (tmp_8_fu_441_p2 | newsignbit_reg_624);

assign tmp_10_fu_386_p3 = p_Val2_3_fu_360_p2[32'd22];
...
assign tmp_6_fu_408_p2 = (newsignbit_fu_400_p3 ^ 1'd1);

assign tmp_8_fu_441_p2 = (signbit_reg_605 ^ 1'd1);

assign tmp_9_fu_383_p1 = tmp_7_reg_600;

assign tmp_fu_294_p1 = init_idx_reg_231;

assign tmp_s_fu_318_p1 = ap_phi_mux_pout_phi_fu_258_p4;

assign underflow_fu_472_p2 = (tmp1_demorgan_fu_467_p2 ^ signbit_reg_605);
