...
(* CORE_GENERATION_INFO="relu_21,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.433000,HLS_SYN_LAT=1681,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=42,HLS_SYN_LUT=182}" *)
...
wire   [2:0] i_1_fu_126_p2;
reg   [2:0] i_1_reg_181;
wire    ap_CS_fsm_state2;
wire   [2:0] j_1_fu_138_p2;
reg   [2:0] j_1_reg_189;
...
assign exitcond1_fu_120_p2 = ((i_reg_87 == 3'd7) ? 1'b1 : 1'b0);

assign exitcond2_fu_132_p2 = ((j_reg_98 == 3'd7) ? 1'b1 : 1'b0);

assign exitcond_fu_144_p2 = ((k_reg_109 == 5'd16) ? 1'b1 : 1'b0);

assign i_1_fu_126_p2 = (i_reg_87 + 3'd1);

assign j_1_fu_138_p2 = (j_reg_98 + 3'd1);
