...
(* CORE_GENERATION_INFO="conv_6,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.855000,HLS_SYN_LAT=50380800,HLS_SYN_TPT=none,HLS_SYN_MEM=1,HLS_SYN_DSP=1,HLS_SYN_FF=216,HLS_SYN_LUT=594}" *)
...
wire   [13:0] indvar_flatten_next_fu_282_p2;
reg   [13:0] indvar_flatten_next_reg_557;
...
assign exitcond_flatten_fu_544_p2 = ((indvar_flatten_reg_225 == 14'd16383) ? 1'b1 : 1'b0);
...
assign indvar_flatten_next_fu_282_p2 = (indvar_flatten_reg_225 + 14'd1);
