...
(* CORE_GENERATION_INFO="conv_0_1,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.855000,HLS_SYN_LAT=8225025,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=1,HLS_SYN_FF=190,HLS_SYN_LUT=765}" *)
...
wire   [4:0] pout_1_fu_512_p2;
reg   [4:0] pout_1_reg_776;
reg    ap_predicate_op101_read_state7;
reg    ap_predicate_op103_read_state7;
reg    ap_block_state7;
reg   [3:0] out_val_V_addr_3_reg_791;
...
wire   [4:0] wr_idx_1_fu_707_p2;
reg   [4:0] wr_idx_1_reg_839;
...
assign exitcond4_fu_442_p2 = ((init_idx_reg_336 == 5'd16) ? 1'b1 : 1'b0);

assign exitcond7_fu_490_p2 = ((pkern_reg_347 == 2'd3) ? 1'b1 : 1'b0);

assign exitcond8_fu_506_p2 = ((pout_reg_369 == 5'd16) ? 1'b1 : 1'b0);

assign exitcond_fu_701_p2 = ((wr_idx_reg_389 == 5'd16) ? 1'b1 : 1'b0);

assign hout_1_fu_406_p2 = (hout_reg_303 + 8'd1);

assign init_idx_1_fu_448_p2 = (init_idx_reg_336 + 5'd1);
...
assign pout_1_fu_512_p2 = (pout_reg_369 + 5'd1);
...
assign wr_idx_1_fu_707_p2 = (wr_idx_reg_389 + 5'd1);
